...
class Players extends Component {
  ...
  async componentDidMount(state) {
    await axios
      ...
      .then((res) => {
        if (res.data) {
          this.setState({ USERSSSS: res.data });
        }
      });
  ...
  render() {
    console.log("users", this.state.users[0]._id);
    console.log("USERSSSS", this.state.USERSSSS);
          ...
          <div>
            ...
            <div className={classes.PlayerForm}>
              ...
              <div key={this.state.users.id}>
                <p>
                  Email: <strong>{this.state.users.email}</strong>
                </p>
                <p>
                  Имя: <strong>{this.state.users.name}</strong>
                </p>
                <p>
                  Ваш возраст: <strong>{this.state.users.age}</strong>
                </p>
                <p>
                  Пол: <strong>{this.state.users.sex}</strong>
                </p>
                <p>
                  Город: <strong>{this.state.users.adress}</strong>
                </p>
              </div>
