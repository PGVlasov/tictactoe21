...
import { range, email } from "lodash";
      ...
      return (
        <div className={classes.Player}>
          ...
          <div className={classes.PlayerForm}>
            ...
            <p>
              {" "}
              Email: <strong>{this.showEmail(email)}</strong>
            </p>
            {/* <p>Рейтинг (количество побед): {this.showRange(range)}</p>
            <p>
        ...
        <div className={classes.Player}>
          ...
          <div className={classes.PlayerForm}>
            ...
            {this.state.users.map((user) => (
              <div key={user.id}>
                <p>
                  Рейтинг (количество побед):{" "}
                  {user.range /* this.showRange(range)} */}
                </p>
                <p>
                  Email: <strong>{user.email}</strong>
                </p>
